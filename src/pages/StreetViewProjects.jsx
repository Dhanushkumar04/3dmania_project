  ...
  const projects = [
    {
      ...
      category: 'Retail',
      description: 'Integration of detailed indoor street view for a multi-level shopping mall, helping customers navigate stores.',
    ...
    },
    {
      ...
      category: 'Restaurant',
      description: 'Showcasing the cozy ambiance of a premium bistro on Google Maps to attract more diners.',
    ...
    },
    {
      ...
      description: 'Allowing the community to virtually explore the library layout and book sections through Google Street View.',
