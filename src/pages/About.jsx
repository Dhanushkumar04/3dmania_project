      ...
      <section className="section">
        <div className="container">
          ...
          <section style={{ marginTop: 'clamp(3rem, 8vw, 4rem)', textAlign: 'center' }}>
            ...
            >
              <img src='https://mania3d-assets.web.app/profile.png' style={{ width: '100%', maxWidth: '300px', height: 'auto', aspectRatio: '1/1', objectFit: 'cover', borderRadius: '10px', margin: '0 auto 2rem', display: 'block', fontSize: 'clamp(2rem, 5vw, 3rem)', color: '#fff', fontWeight: 800 }} />
